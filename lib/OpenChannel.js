...
class OpenChannel extends Sendbird {
    constructor(apiToken, regionIdentifier, version) {
        super(apiToken, 'open_channels', regionIdentifier, version);
    }
    ...
    */
    async listParticipants(params) {
        let req = this._makeParams('GET', 'listParticipants', params.channel_url, params);
        return await this._request(req);
    }
