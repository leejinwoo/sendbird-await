...
class User extends Sendbird {
    constructor(apiToken, appIdOrRegion, version) {
        super(apiToken, 'users', appIdOrRegion, version);
    }
    ...
    */
    async token(params) {
        const req = this._makeParams('POST', 'token', params.user_id, params);
        return await this._request(req);
    }
    ...
    */
    async revokeToken(params) {
        const req = this._makeParams('DELETE', 'token', params.user_id, params);
        return await this._request(req);
    }
}
