...
class User extends Sendbird {
    ...
    */
    async unreadMessageCount(params) {
        let req = this._makeParams('GET', 'unreadMessageCount', params.user_id);
        return await this._request(req);
    }
    ...
    */
    async unreadChannelCount(params) {
        let req = this._makeParams('GET', 'unreadChannelCount', params.user_id);
        return await this._request(req);
    }
    ...
    */
    async blocklist(params) {
        let req = this._makeParams('GET', 'block', params.user_id);
        return await this._request(req);
    }
    ...
    */
    async banChannels(params) {
        let req = this._makeParams('GET', 'banChannels', params.user_id);
        return await this._request(req);
    }
    ...
    */
    async mutedChannels(params) {
        let req = this._makeParams('GET', 'mutedChannels', params.user_id);
        return await this._request(req);
    }
    ...
    */
    async unregisterPushToken(params) {
        ...
        if (params.isAll) {
            ...
            req = this._makeParams('DELETE', 'unregisterPushToken', [params.user_id, params.token_type, params[params.token_type]]);
        }
        return await this._request(req);
    }
